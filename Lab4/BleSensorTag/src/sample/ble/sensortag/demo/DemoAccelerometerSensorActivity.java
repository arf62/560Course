...
public class DemoAccelerometerSensorActivity extends DemoSensorActivity {
    ...
    public void displayInstructions(View view){
    	...
    	viewText.setText(R.string.Game_Instructions);
    }
public void startGame(View view){
		
		Intent gameIntent = new Intent(this, Timed_Images.class);
		gameIntent.putExtra(DemoAccelerometerSensorActivity.EXTRAS_DEVICE_ADDRESS, getIntent().getStringExtra(EXTRAS_DEVICE_ADDRESS));
        gameIntent.putExtra(DemoSensorActivity.EXTRAS_SENSOR_UUID, getIntent().getStringExtra(EXTRAS_SENSOR_UUID ));
