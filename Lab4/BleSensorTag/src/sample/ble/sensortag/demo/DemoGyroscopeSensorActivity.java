 ...
 */
public class DemoGyroscopeSensorActivity extends DemoSensorActivity {
    private final static String TAG = DemoGyroscopeSensorActivity.class.getSimpleName();
    ...
    private static class OpenGLRenderer implements GLSurfaceView.Renderer {
        ...
        public void setRotation(float[] rotation) {
            this.rotation[0] += rotation[0] % 360;
            this.rotation[1] += rotation[1] % 360;
            this.rotation[2] += rotation[2] % 360;
        }
